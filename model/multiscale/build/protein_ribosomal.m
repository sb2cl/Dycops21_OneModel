classdef protein_ribosomal
	...
	methods
		function obj = protein_ribosomal()
			%% Constructor of protein_ribosomal.
		...
		function p = default_parameters(~)
			...
			p.p_nr__d_m = 0.16;
			p.p_nr__k_b = 4.7627;
			p.p_nr__k_u = 119.7956;
			p.p_nr__l_p = 195.0;
			p.p_nr__l_e = 25.0;
			p.p_nr__weigth = 0.0045;
		end
		...
		function dx = ode(~,t,x,p)
			...
			p_nr__r_t = p_nr__m./p.p_nr__weigth;
		...
		function out = simout2struct(~,t,x,p)
			...
			out.p_nr__r_t = p_nr__r_t.*ones_t;
			...
			out.p_nr__weigth = p.p_nr__weigth.*ones_t;
